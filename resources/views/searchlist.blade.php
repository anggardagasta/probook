                            ...
                            <div class="property-container">
                                <div class="property-content-list">
                                    ...
                                    <div class="property-text">
                                        <h3><a href="#">Land In Central Park</a>
                ...
                <div class="col-md-3 col-md-pull-9 sidebar">
                    ...
                    <div class="widget-sidebar">
                        <ul id="myTab" class="nav nav-tabs">
                            <li class="active"><a href="#popular" data-toggle="tab" title="Popular Property"><i
                                            class="fa fa-star-o"></i></a></li>
                            <li class=""><a href="#recent" data-toggle="tab" title="Recent Property"><i
                                            class="fa fa-clock-o"></i></a></li>
                            <li class=""><a href="#tags" data-toggle="tab" title="Tags"><i class="fa fa-tags"></i></a>
                            </li>
                            <li class=""><a href="#archives" data-toggle="tab" title="Archives"><i
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade" id="recent">
                                <div class="post-container">
                                    <div class="post-img" style="background: url(img/img06.jpg);"><h3>For Sale</h3>
                                    </div>
                                    <div class="post-content">
                                        <div class="post-meta">
                                ...
                                <!-- break -->
                                <div class="post-container">
                                    <div class="post-img" style="background: url(img/img07.jpg);"><h3>For Rent</h3>
                                    </div>
                                    <div class="post-content">
                                        <div class="post-meta">
                                ...
                                <!-- break -->
                                <div class="post-container">
                                    <div class="post-img" style="background: url(img/img08.jpg);"><h3>For Sale</h3>
                                    </div>
                                    <div class="post-content">
                                        <div class="post-meta">
                                            <span><i class="fa fa-home"></i> 7,000 m<sup>2</sup> / </span>
                            ...
                            <div class="tab-pane fade" id="tags">
                                <div class="widget">
                                    <a href="#">Food truck</a> <a href="#">fixie locavore</a> <a href="#">accusamus
                                        mcsweeney's</a> <a href="#">marfa nulla</a> <a href="#">single-origin</a> <a
                                            href="#">coffee squid</a>
                                </div>
                            </div>
                            <!-- end:tags -->
